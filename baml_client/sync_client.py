...
class BamlSyncClient:
    ...
    def TriageLogs(self, log_chunk: str,
        ...
        if 'on_tick' in baml_options:
            ...
            __result__ = self.__options.merge_options(baml_options).call_function_sync(function_name="TriageLogs", args={
                "log_chunk": log_chunk,
            })
...
class BamlStreamClient:
    ...
    def TriageLogs(self, log_chunk: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[stream_types.TriageResult, types.TriageResult]:
        __ctx__, __result__ = self.__options.merge_options(baml_options).create_sync_stream(function_name="TriageLogs", args={
            "log_chunk": log_chunk,
        })
        return baml_py.BamlSyncStream[stream_types.TriageResult, types.TriageResult](
          __result__,
...
class BamlHttpRequestClient:
    ...
    def TriageLogs(self, log_chunk: str,
        ...
        __result__ = self.__options.merge_options(baml_options).create_http_request_sync(function_name="TriageLogs", args={
            "log_chunk": log_chunk,
        }, mode="request")
        return __result__
